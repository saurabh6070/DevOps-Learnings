...
| 5 | [📁 File & Directory Management — softlink, hardlink, hidden files, tar, gzip, bzip2](#5--file--directory-management) |
| 6 | [🔐 File Permissions & Ownership](#6--file-permissions--ownership) |
| 7 | [👤 User & Group Management — UIDs, GIDs, passwd, shadow, root↔normal conversion](#7--user--group-management) |
| 8 | [⚙️ Process Management](#8-%EF%B8%8F-process-management) |
| 9 | [💾 Disk & Storage Management — fdisk (primary/extended/logical), mkfs, inodes, fstab](#9--disk--storage-management) |
| 10 | [📦 Package Management — RPM, YUM, YUM server setup, vsftpd+GPG](#10--package-management) |
| 11 | [🌐 Networking — LAN, WAN, OSI, ifcfg/ONBOOT, NetworkManager, hostname, hosts.deny, /etc/network/interfaces, casting types](#11--networking-in-linux) |
| 12 | [🔥 Firewall — firewalld, ufw, iptables, SNAT, DNAT, source-based routing](#12--firewall-management) |
| 13 | [🔒 SSH — config, key auth, passwordless, SCP, protocols](#13--ssh--remote-access) |
| 14 | [⚙️ Systemd & Service Management](#14-%EF%B8%8F-systemd--service-management) |
| 15 | [📋 Linux Logs & Monitoring](#15--linux-logs--monitoring) |
| 16 | [🧠 Memory & CPU Management](#16--memory--cpu-management) |
| 17 | [⏰ Scheduling Tasks — Cron & At](#17--scheduling-tasks--cron--at) |
| 18 | [📝 Text Processing — grep, awk, sed](#18--text-processing--grep-awk-sed) |
| 19 | [🔗 Shell & Environment Variables — .bash_profile, .bashrc, .bash_logout, alias](#19--shell--environment-variables) |
| 20 | [📜 Shell Scripting](#20--shell-scripting) |
| 21 | [🔒 Linux Security & Hardening — SELinux, sudo, visudo](#21--linux-security--hardening) |
| 22 | [💡 LVM — PV, VG, LV — create, extend, reduce, snapshots](#22--lvm--logical-volume-management) |
| 23 | [🗃️ NFS & Samba — /etc/exports, smb.conf, full setup](#23-%EF%B8%8F-nfs--samba-file-sharing) |
| 24 | [🔄 Backup & Recovery](#24--backup--recovery) |
| 25 | [🚀 Performance Tuning — sysctl.conf, IP forwarding, ulimit](#25--performance-tuning) |
| 26 | [🐚 Vi / Vim Editor](#26--vi--vim-editor) |
| 27 | [⚡ Quick Reference Cheat Sheet](#27--quick-reference-cheat-sheet) |
| 28 | [🐚 Shell Profile Files — .bash_profile, .bashrc, .bash_logout](#28--shell-profile-files--bash_profile-bashrc-bash_logout) |
| 29 | [🗂️ Inodes — Linux Filesystem Internals](#29-%EF%B8%8F-inodes--understanding-the-linux-filesystem-internals) |
| 30 | [💾 Advanced fdisk — Primary, Extended, Logical Partitions, mkfs, fstab](#30--advanced-disk-management--fdisk-partitions--filesystems) |
| 31 | [👥 UIDs & GIDs — root UID=0, system vs user IDs, root↔normal conversion](#31--uids-gids--user-and-group-ids-in-linux) |
| 32 | [📁 /etc/passwd and /etc/shadow — complete field breakdown](#32--etcpasswd-and-etcshadow--user-database-files) |
| 33 | [🔄 /etc/inittab, Runlevels — switching GUI↔CLI](#33--etcinittab-and-runlevels--switching-between-gui-and-cli) |
| 34 | [🌐 Networking Deep Dive — LAN/WAN, OSI 7 layers, RHEL ifcfg ONBOOT, NetworkManager, hostname, hosts.deny, casting types, SDN](#34--networking-in-linux--lan-wan-osi-and-configuration-files) |
| 35 | [📦 RPM, YUM Server Setup, vsftpd with GPGcheck](#35--software-management--rpm-yum-server-setup) |
| 36 | [🔥 Firewall — SNAT, DNAT, Source-Based Routing, sysctl IP forwarding](#36--firewall--snat-dnat-source-based-routing) |
| 37 | [🌐 DNS Server — named.conf, A/CNAME/MX/NS/SRV/NAPTR/PTR records, forward/reverse zones, resolv.conf, nslookup](#37--dns-server-setup--namedconf-record-types-zones) |
| 38 | [🖥️ DHCP Server — dhcpd.conf, static reservations](#38--dhcp-server-setup) |
| 39 | [🕐 NTP — chrony, ntpd, timedatectl](#39--ntp--network-time-protocol) |
| 40 | [🌐 Samba Server — full implementation, smb.conf, mount](#40--samba-server--full-implementation) |
| 41 | [📂 /etc/exports — NFS share options (rw, ro, root_squash)](#41--etcexports--nfs-shares-configuration) |
| 42 | [🌐 vsftpd — complete setup with GPG](#42--ftp--vsftpd-complete-setup) |
| 43 | [🔐 GRUB2 Password Recovery + /etc/rc.local](#43--grub2-password--recovery-when-password-forgotten) |
| 44 | [🔒 RAID-5 — theory, implementation with mdadm](#44--raid--redundant-array-of-independent-disks) |
| 45 | [🌐 SDN — Software Defined Networking, Open vSwitch](#45--sdn--software-defined-networking) |
| 46 | [🔒 sudo and visudo — sudoers syntax, NOPASSWD, aliases](#46--sudo-and-visudo--privilege-management) |
| 47 | [🌐 Apache — httpd.conf, VirtualHost, SSL](#47--http-server--apache-httpdconf) |
| 48 | [🔑 Hidden Files and alias](#48--hidden-files-and-aliases) |
| 49 | [📊 wall — broadcast messages, /etc/motd](#49--wall--broadcast-message-to-all-users) |
| 50 | [🔄 gzip, bzip2, xz, tar — complete reference](#50--gzip-bzip2-tar--complete-reference) |
| 51 | [🔐 Passwordless SSH — step-by-step setup](#51--password-less-ssh-authentication--complete-setup) |
| 26 | [🐚 Vi / Vim Editor](#26--vi--vim-editor) |
| 27 | [⚡ Quick Reference Cheat Sheet](#27--quick-reference-cheat-sheet) |
...
### 5.3 Deleting Files and Directories
...
### 5.6 File Compression and Archives
...
# Options meaning: c=create x=extract t=list v=verbose f=file z=gzip j=bzip2
...
### 7.3 Password Policy — /etc/shadow
...
### 8.3 Signals and killing processes
...
### 8.4 Background and Foreground Jobs
...
### 8.5 Process Priority (nice / renice)
...
### 9.5 /etc/fstab — Persistent Mounts
...
# level=0 (striping), 1 (mirroring), 5 (striping+parity), 6, 10
...
### 10.2 YUM / DNF — RHEL/CentOS/Fedora
...
### 12.1 firewalld (RHEL/CentOS/Fedora)
...
### 12.2 ufw — Uncomplicated Firewall (Ubuntu)
...
### 12.3 iptables — Low-Level Firewall
...
### 13.2 SSH Config File (~/.ssh/config)
...
### 13.3 SCP and SFTP — Secure File Transfer
...
### 13.4 SSH Server Configuration (/etc/ssh/sshd_config)
...
## 14. ⚙️ Systemd & Service Management

### 14.1 systemctl — Control Services
...
## 17. ⏰ Scheduling Tasks — Cron & At

### 17.1 cron — Recurring Jobs
...
### 17.2 at — One-Time Scheduled Jobs
...
### 17.3 systemd Timers (Modern Alternative)
...
## 18. 📝 Text Processing — grep, awk, sed

### 18.1 grep — Search Text
...
## 19. 🔗 Shell & Environment Variables
...
### 19.2 Important Environment Variables
...
### 20.7 Practical Script Examples
...
### 21.4 System Hardening Checklist
...
## 22. 💡 LVM — Logical Volume Management
...
## 23. 🗃️ NFS & Samba (File Sharing)

### 23.1 NFS — Network File System
...
### 23.2 Samba — SMB/CIFS (Windows-compatible sharing)
...
### 25.5 ulimit — User Resource Limits
...
^            # Jump to first non-whitespace of line
$            # Jump to end of line
...
## 28. 🐚 Shell Profile Files — `.bash_profile`, `.bashrc`, `.bash_logout`

### 28.1 Profile File Execution Order
...
### 28.2 `.bash_profile` — Login Shell Config
...
### 28.3 `.bashrc` — Interactive Shell Config
...
### 28.4 `.bash_logout` — Logout Cleanup
...
### 28.5 Applying Changes Without Logout
...
## 29. 🗂️ Inodes — Understanding the Linux Filesystem Internals

### 29.1 What is an Inode?
...
### 29.4 Soft Links (Symbolic Links) and Inodes
...
## 30. 💾 Advanced Disk Management — fdisk, Partitions & Filesystems

### 30.1 Understanding Partition Types
...
### 30.2 fdisk — Complete Command Reference
...
### 30.3 Creating Filesystems (mkfs)
...
### 30.4 /etc/fstab — Permanent Mounts
...
## 31. 👥 UIDs, GIDs — User and Group IDs in Linux
...
### 31.3 root User Special Properties
...
### 31.4 Convert Root User ↔ Normal User
...
## 32. 📁 /etc/passwd and /etc/shadow — User Database Files

### 32.1 /etc/passwd — User Account Database
...
### 32.2 /etc/shadow — Encrypted Password Storage
...
## 33. 🔄 /etc/inittab and Runlevels — Switching Between GUI and CLI

### 33.1 Traditional Runlevels (/etc/inittab)
...
### 33.2 Switching Between GUI and CLI (Modern systemd)
...
### 33.3 Runlevel-to-Target Mapping
...
## 34. 🌐 Networking in Linux — LAN, WAN, OSI, and Configuration Files
...
### 34.3 Types of Casting (Communication Modes)
...
### 34.4 RHEL Network Config Files — /etc/sysconfig/network-scripts/
...
### 34.6 /etc/network/interfaces — Debian/Ubuntu (Older)
...
### 34.8 /etc/hosts — Local Name Resolution
...
### 34.9 /etc/hosts.deny and /etc/hosts.allow — TCP Wrappers
...
## 35. 📦 Software Management — RPM, YUM Server Setup

### 35.1 RPM — Red Hat Package Manager

```bash
# Install:
rpm -ivh package.rpm              # Install (-i=install, -v=verbose, -h=progress)
rpm -Uvh package.rpm              # Upgrade (or install if not present)
rpm -Fvh package.rpm              # Freshen (upgrade ONLY if already installed)

# Remove:
rpm -e nginx                      # Remove package
rpm -e --nodeps nginx             # Remove ignoring dependencies

# Query:
rpm -qa                           # List ALL installed packages
rpm -qa | grep nginx              # Search installed
rpm -qi nginx                     # Package info
rpm -ql nginx                     # List files from package
rpm -qf /etc/nginx/nginx.conf     # Which package owns this file
rpm -qR nginx                     # List requirements (dependencies)
rpm -qd nginx                     # Documentation files only
rpm -qc nginx                     # Config files only
rpm -V nginx                      # Verify package files integrity
...
### 35.2 YUM — Yellowdog Updater Modified (RHEL 7 and older)
...
### 35.3 Setting Up a Local YUM Repository Server
...
## 36. 🔥 Firewall — SNAT, DNAT, Source-Based Routing

### 36.1 NAT — Network Address Translation
...
### 36.2 Source-Based Routing (Policy Routing)
...
### 36.3 sysctl.conf — IP Forwarding and Kernel Network Parameters
...
## 37. 🌐 DNS Server Setup — named.conf, Record Types, Zones
...
### 37.2 /etc/resolv.conf — Client DNS Config
...
### 37.4 Setting Up BIND DNS Server
...
## 38. 🖥️ DHCP Server Setup

### 38.1 Installing and Configuring dhcpd
...
### 39.4 timedatectl (systemd time management)
...
## 40. 🌐 Samba Server — Full Implementation
...
## 41. 📂 /etc/exports — NFS Shares Configuration

### 41.1 /etc/exports Syntax
...
```
# Format: /path  client(options)  client2(options2)
#
/opt/shared        192.168.1.0/24(rw,sync,no_subtree_check)
/opt/public        *(ro,sync)
/home/alice        10.0.0.5(rw,sync,root_squash)
/data              192.168.1.100(rw,no_root_squash,async)
/mnt/backup        192.168.1.0/24(rw,sync,no_subtree_check,anonuid=1001,anongid=1001)
```
...
| `ro` | Read-only access |
| `sync` | Write data to disk before replying (safe) |
| `async` | Write asynchronously (faster, risky) |
| `root_squash` | Map remote root to anonymous user (safe, **default**) |
| `no_root_squash` | Remote root = local root (**dangerous**) |
| `all_squash` | Map ALL users to anonymous |
| `anonuid=X` | UID for anonymous mapped user |
| `anongid=X` | GID for anonymous mapped user |
| `no_subtree_check` | Disable subtree checking (recommended for performance) |
| `subtree_check` | Verify file is in exported subtree (slower) |
| `secure` | Require client port < 1024 (default) |
| `insecure` | Allow any client port |

```bash
# Apply export changes:
exportfs -a                     # Export all from /etc/exports
exportfs -r                     # Re-export all (refresh)
exportfs -u /opt/shared         # Unexport specific share
exportfs -v                     # List active exports
exportfs -f                     # Flush export cache

# Show exports on a server:
...
## 42. 🌐 FTP — vsftpd Complete Setup

### 42.1 vsftpd — Very Secure FTP Daemon
...
# Chroot (jail) users to home:
chroot_local_user=YES
chroot_list_enable=YES
chroot_list_file=/etc/vsftpd/chroot_list    # Users in this list are NOT jailed
allow_writeable_chroot=YES                  # Allow writable chroot (needed sometimes)

# Passive mode for NAT/firewall:
pasv_enable=YES
pasv_min_port=10090
pasv_max_port=10100
...
userlist_deny=YES                           # YES=deny users in list, NO=allow only those in list
...
firewall-cmd --permanent --add-port=10090-10100/tcp  # Passive mode ports
firewall-cmd --reload

# Test:
ftp 192.168.1.100
# or:
lftp -u alice 192.168.1.100
```

---

## 43. 🔐 GRUB2 Password — Recovery When Password Forgotten

### 43.1 Reset Root Password via GRUB
...
### 43.2 GRUB2 Password Protection
...
### 43.3 /etc/rc.local — Legacy Startup Scripts
...
## 44. 🔒 RAID — Redundant Array of Independent Disks

### 44.1 RAID Levels Explained
...
### 44.3 RAID-5 Implementation with mdadm
...
## 45. 🌐 SDN — Software Defined Networking

### 45.1 What is SDN?

**Software Defined Networking (SDN)** decouples the **control plane** (routing decisions) from the **data plane** (packet forwarding), making networks programmable and centrally manageable.

```
Traditional Networking:          SDN Architecture:
  Each switch/router has         ┌─────────────────────┐
  its own control plane          │   SDN Controller     │  ← Centralized
  (routing logic built-in)       │ (OpenDaylight, ONOS) │    Control Plane
                                 └──────────┬──────────┘
                                 OpenFlow / NETCONF / REST API
                              ┌──────┴──────┐
                         ┌────┴────┐  ┌─────┴────┐
                         │ Switch1 │  │ Switch2  │  ← Data Plane only
                         └─────────┘  └──────────┘   (forwarding only)
```
...
```bash
# Open vSwitch (OVS) — Software SDN switch:
yum install openvswitch -y
systemctl enable --now openvswitch

# Create OVS bridge:
ovs-vsctl add-br ovs-br0
ovs-vsctl add-port ovs-br0 eth0      # Add physical interface
ovs-vsctl add-port ovs-br0 vnet0     # Add VM interface

# View OVS status:
ovs-vsctl show
ovs-ofctl show ovs-br0

# Flow rules (like iptables but for L2/L3):
ovs-ofctl add-flow ovs-br0 "in_port=1,action=output:2"
ovs-ofctl dump-flows ovs-br0

# SDN relevance in Linux:
...
## 46. 🔒 sudo and visudo — Privilege Management

### 46.1 sudo — Superuser Do
...
### 46.2 visudo — Safe Sudoers Editor
...
## 47. 🌐 HTTP Server — Apache httpd.conf

### 47.1 Apache httpd Configuration
...
## 48. 🔑 Hidden Files and Aliases

### 48.1 Hidden Files in Linux
...
## 49. 📊 wall — Broadcast Message to All Users
...
## 50. 🔄 gzip, bzip2, tar — Complete Reference
...
gzip -1 file.txt                   # Fast compression (larger)
gzip file1.txt file2.txt           # Compress multiple files

# Decompress:
gzip -d file.txt.gz                # Decompress
gunzip file.txt.gz                 # Same
gzip -dk file.txt.gz               # Decompress + keep .gz

# View without decompressing:
zcat file.txt.gz                   # cat for gzip
zless file.txt.gz                  # less for gzip
zgrep "error" file.txt.gz          # grep for gzip

# Info:
gzip -l file.txt.gz               # Compression ratio and sizes
```
...
# CREATE:
tar -cvf archive.tar dir/          # Create uncompressed tar
tar -cvzf archive.tar.gz dir/      # Create gzip-compressed tar
tar -cvjf archive.tar.bz2 dir/     # Create bzip2-compressed tar
tar -cvJf archive.tar.xz dir/      # Create xz-compressed tar

# EXTRACT:
tar -xvf archive.tar               # Extract tar
tar -xvzf archive.tar.gz           # Extract gzip tar
tar -xvjf archive.tar.bz2          # Extract bzip2 tar
tar -xvzf archive.tar.gz -C /opt/  # Extract to specific directory
...
tar -xvzf archive.tar.gz etc/nginx/nginx.conf
...
## 51. 🔐 Password-less SSH Authentication — Complete Setup

### 51.1 How Key-Based Auth Works
...
The following sections have been added to this guide:

| # | New Section |
|---|-------------|
| 28 | [🐚 Shell Profile Files — .bash_profile, .bashrc, .bash_logout](#28--shell-profile-files--bash_profile-bashrc-bash_logout) |
| 29 | [🗂️ Inodes — Linux Filesystem Internals](#29-%EF%B8%8F-inodes--understanding-the-linux-filesystem-internals) |
| 30 | [💾 Advanced Disk Management — fdisk, Partitions, mkfs](#30--advanced-disk-management--fdisk-partitions--filesystems) |
| 31 | [👥 UIDs, GIDs — User and Group IDs](#31--uids-gids--user-and-group-ids-in-linux) |
| 32 | [📁 /etc/passwd and /etc/shadow](#32--etcpasswd-and-etcshadow--user-database-files) |
| 33 | [🔄 /etc/inittab, Runlevels, GUI/CLI switching](#33--etcinittab-and-runlevels--switching-between-gui-and-cli) |
| 34 | [🌐 Networking — LAN, WAN, OSI, RHEL ifcfg, NetworkManager, Hostname, hosts.deny, /etc/network/interfaces, Casting Types](#34--networking-in-linux--lan-wan-osi-and-configuration-files) |
| 35 | [📦 Software Management — RPM, YUM Server Setup, vsftpd with GPG](#35--software-management--rpm-yum-server-setup) |
| 36 | [🔥 Firewall — SNAT, DNAT, Source-Based Routing, sysctl.conf](#36--firewall--snat-dnat-source-based-routing) |
| 37 | [🌐 DNS Server — named.conf, Record Types, Forward/Reverse Lookup](#37--dns-server-setup--namedconf-record-types-zones) |
| 38 | [🖥️ DHCP Server — dhcpd.conf](#38--dhcp-server-setup) |
| 39 | [🕐 NTP — chrony, ntpd, timedatectl](#39--ntp--network-time-protocol) |
| 40 | [🌐 Samba Server — Full Implementation](#40--samba-server--full-implementation) |
| 41 | [📂 /etc/exports — NFS Shares Configuration](#41--etcexports--nfs-shares-configuration) |
| 42 | [🌐 FTP — vsftpd Complete Setup](#42--ftp--vsftpd-complete-setup) |
| 43 | [🔐 GRUB2 Password Recovery, /etc/rc.local](#43--grub2-password--recovery-when-password-forgotten) |
| 44 | [🔒 RAID-5 — Info and Implementation with mdadm](#44--raid--redundant-array-of-independent-disks) |
| 45 | [🌐 SDN — Software Defined Networking](#45--sdn--software-defined-networking) |
| 46 | [🔒 sudo and visudo — Privilege Management](#46--sudo-and-visudo--privilege-management) |
| 47 | [🌐 Apache httpd.conf](#47--http-server--apache-httpdconf) |
| 48 | [🔑 Hidden Files and alias](#48--hidden-files-and-aliases) |
| 49 | [📊 wall — Broadcast Messages](#49--wall--broadcast-message-to-all-users) |
| 50 | [🔄 gzip, bzip2, tar — Complete Reference](#50--gzip-bzip2-tar--complete-reference) |
| 51 | [🔐 Password-less SSH — Complete Setup](#51--password-less-ssh-authentication--complete-setup) |
